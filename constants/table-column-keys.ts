...
const TABLE_COLUMN_OBJECTS = {
  ...
  system_connections: {
    ...
    working_fiber_in_id: "working_fiber_in_id",
    working_fiber_out_id: "working_fiber_out_id",
    protection_fiber_in_id: "protection_fiber_in_id",
    protection_fiber_out_id: "protection_fiber_out_id",
