<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/1_tables/2_fiber_splices.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/1_tables/1_junction_closures.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/1_tables/9_advanced_ofc_tables.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/4_triggers/1_updated_at_triggers.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/2_views/8_v_system_ring_paths_detailed.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/2_views/1_v_end_to_end_paths.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/2_views/2_v_cable_utilization.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/3_indexes/1_advanced_ofc_indexes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/04_advanced_ofc/5_constraints/1_add_fk_constraints.sql -->
```sql
-- =================================================================
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/4_indexes/2_fts_indexes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/4_indexes/1_core_indexes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/5_triggers/3_dom_update_triggers.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/5_triggers/2_updated_at_triggers.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/8_ofc_connections.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/2_maintenance_areas.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/7_ofc_cables.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/5_rings.sql -->
```sql
-- Ring Master Table
create table rings (
  id UUID primary key default gen_random_uuid(),
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/1_lookup_types.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/4_employees.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/6_nodes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/1_tables/3_employee_designations.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/2_functions/1_update_updated_at_column.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/2_functions/3_dom_update_functions.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/2_v_maintenance_areas_with_count.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/6_v_nodes_complete.sql -->
```sql
-- Complete Node Information View (SECURITY INVOKER)
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/5_v_rings_with_count.sql -->
```sql
-- Complete Node Information View (SECURITY INVOKER)
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/1_v_lookup_types_with_count.sql -->
```sql
-- Complete Node Information View (SECURITY INVOKER)
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/4_v_employees_with_count.sql -->
```sql
-- Complete Node Information View (SECURITY INVOKER)
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/7_v_ofc_cables_complete.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/3_views/3_v_employee_designations_with_count.sql -->
```sql
-- Complete Node Information View (SECURITY INVOKER)
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/02_core_infrastructure/6_files/files_rows.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/05_auditing/3_triggers/1_attach_logging_triggers.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/05_auditing/1_tables/1_user_activity_logs.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/05_auditing/2_functions/1_log_user_activity.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/05_auditing/2_functions/2_log_data_changes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/06_sdh_connections.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/9_vmux_connections.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/03_management_ports.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/04_consolidated_system_tables.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/02_system_connections.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/8_vmux_systems.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/7_sdh_node_associations.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/01_systems.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/1_tables/05_sdh_systems.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/4_triggers/1_updated_at_triggers.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/2_views/1_v_systems_complete.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/2_views/2_v_system_connections_complete.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/2_views/3_v_ofc_connections_complete.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/3_indexes/2_fts_indexes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/3_indexes/1_system_indexes.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/03_network_systems/5_constraints/1_add_fk_constraints.sql -->
```sql
-- =================================================================
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/4_indexes/1_user_profile_indexes.sql -->
```sql
-- =================================================================
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/5_triggers/3_sync_user_role_trigger.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/5_triggers/4_sync_user_role_insert_trigger.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/5_triggers/2_update_user_profile_updated_at.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/5_triggers/1_on_auth_user_created.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/1_tables/1_user_profiles.sql -->
```sql
-- User profiles table
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/2_utility_functions/3_get_my_user_details.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/2_utility_functions/2_get_my_role.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/2_utility_functions/1_is_super_admin.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/1_admin_functions/2_admin_get_user_by_id.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/1_admin_functions/3_admin_update_user_profile.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/1_admin_functions/1_admin_get_all_users.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/1_admin_functions/5_admin_bulk_update_role.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/1_admin_functions/6_admin_bulk_delete_users.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/1_admin_functions/4_admin_bulk_update_status.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/3_trigger_functions/2_sync_user_role_to_auth.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/3_trigger_functions/3_create_public_profile_for_new_user.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/3_functions/3_trigger_functions/1_update_user_profile_timestamp.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/2_views/1_v_user_profiles_extended.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/01_user_management/2_views/2_admin_get_all_users_extended.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/3_aggregation_functions/2_get_entity_counts.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/3_aggregation_functions/1_aggregate_query.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/4_pagination_functions/12_get_continuous_available_fibers.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/4_pagination_functions/11_get_system_path_details.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/2_query_execution_functions/1_execute_sql.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/2_query_execution_functions/2_get_unique_values.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/5_data_operation_functions/3_get_jc_splicing_details.sql -->
```sql
-- =================================================================
...
BEGIN
    ...
    WITH connected_cables AS (
        -- Find all unique cables that are either incoming or outgoing from any splice in this JC
    ...
    cables_with_fibers AS (
        SELECT
            ...
            sn.name as start_node_name,
            en.name as end_node_name,
            -- Generate a row for each fiber in the cable
    ...
    fiber_splice_info AS (
        SELECT
            ...
            cf.capacity,
            cf.fiber_no,
            -- Check incoming splices
            inc_splice.id AS incoming_splice_id,
            inc_splice.outgoing_cable_id,
            inc_splice.outgoing_fiber_no,
            out_cable.route_name AS outgoing_route_name,
            -- Check outgoing splices
            out_splice.id AS outgoing_splice_id,
            out_splice.incoming_cable_id,
            out_splice.incoming_fiber_no,
            inc_cable.route_name as incoming_route_name,
            -- Determine status
            CASE
        ...
        LEFT JOIN public.fiber_splices inc_splice
            ON cf.cable_id = inc_splice.incoming_cable_id AND cf.fiber_no = inc_splice.incoming_fiber_no AND inc_splice.jc_id = p_jc_id
        LEFT JOIN public.fiber_splices out_splice
            ON cf.cable_id = out_splice.outgoing_cable_id AND cf.fiber_no = out_splice.outgoing_fiber_no AND out_splice.jc_id = p_jc_id
        ...
        'cables', (
            SELECT jsonb_agg(
                DISTINCT jsonb_build_object(
                    'cable_id', fsi.cable_id,
                    'route_name', fsi.route_name,
                    'capacity', fsi.capacity,
                    'start_node', fsi.start_node_name,
                    'end_node', fsi.end_node_name,
                    'fibers', (
                        SELECT jsonb_agg(
                            jsonb_build_object(
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/5_data_operation_functions/1_bulk_update.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/5_data_operation_functions/2_provision_fiber_on_path.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/3_lookup_type_functions.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/06_utility_functions/6_dashboard_functions/1_dashboard_overview.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/99_security/1_setup/1_create_roles.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/99_security/3_grants/1_user_management_grants.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/99_security/2_policies/2_core_tables_policies.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/99_security/2_policies/3_system_tables_policies.sql -->
```sql
...
<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/99_security/2_policies/4_route.sql -->
```sql
-- =================================================================
-- Step 3.1: Grant Table-Level Permissions
-- Give the 'authenticated' role the ability to perform actions on our new tables.
-- =================================================================

GRANT SELECT, INSERT, UPDATE, DELETE ON public.junction_closures TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.fiber_splices TO authenticated;

-- Grant usage on sequences if your tables use them for IDs (though we use UUIDs)
-- This is good practice to include.
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA public TO authenticated;


-- =================================================================
-- Step 3.2: Create Row-Level Security (RLS) Policies
-- Define rules for WHO can access WHICH rows. For now, we'll allow any logged-in user.
-- =================================================================

-- Policies for `junction_closures`
CREATE POLICY "Allow authenticated users to manage junction_closures"
ON public.junction_closures
FOR ALL
USING (auth.role() = 'authenticated')
WITH CHECK (auth.role() = 'authenticated');

-- Policies for `fiber_splices`
CREATE POLICY "Allow authenticated users to manage fiber_splices"
ON public.fiber_splices
FOR ALL
USING (auth.role() = 'authenticated')
WITH CHECK (auth.role() = 'authenticated');

-- =================================================================
-- Step 3.3: Re-create policies if they already exist from a partial run
-- This makes the script re-runnable without errors.
-- =================================================================

-- Drop existing policies if they exist, then create them.
-- This is an alternative to CREATE POLICY IF NOT EXISTS for broader compatibility.
DROP POLICY IF EXISTS "Allow authenticated users to manage junction_closures" ON public.junction_closures;
CREATE POLICY "Allow authenticated users to manage junction_closures"
ON public.junction_closures FOR ALL
USING (auth.role() = 'authenticated')
WITH CHECK (auth.role() = 'authenticated');

DROP POLICY IF EXISTS "Allow authenticated users to manage fiber_splices" ON public.fiber_splices;
CREATE POLICY "Allow authenticated users to manage fiber_splices"
ON public.fiber_splices FOR ALL
USING (auth.role() = 'authenticated')
WITH CHECK (auth.role() = 'authenticated');


-- Final confirmation
SELECT 'Permissions and RLS policies for Route Manager tables applied successfully.' as status;
```

<!-- path: /home/au/Desktop/git_projects/newhnvtx/hnvtx/data/telecom_network_db/99_security/2_policies/1_user_profiles_policies.sql -->
```sql
