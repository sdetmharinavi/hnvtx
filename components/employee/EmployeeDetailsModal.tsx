...
const EmployeeDetailsModal = ({ employee, employeeId, onClose, onEdit }: Props) => {
  ...
  // Use the passed employee or the fetched employee with proper typing
  const currentEmployee = (employee || fetchedEmployee) as EmployeeData | null;

  // Type guard to ensure employee data exists
  if (!currentEmployee) {
    return (
      <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
        <div className='bg-white p-8 rounded-lg shadow-xl max-w-md w-full mx-4'>
          <h3 className='text-lg font-medium text-red-600 mb-4'>No Data</h3>
          <p className='text-gray-700 mb-4'>Employee data not available</p>
          <button
            onClick={onClose}
        ...
        <div className='space-y-4'>
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='font-medium'>{currentEmployee.employee_name || 'Not provided'}</p>
            </div>
          </div>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='font-medium'>{currentEmployee.employee_email || 'Not provided'}</p>
            </div>
          </div>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='font-medium'>{currentEmployee.employee_contact || 'Not provided'}</p>
            </div>
          </div>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='font-medium'>
                {currentEmployee.employee_designations?.name || 'Not provided'}
              </p>
            </div>
          </div>
          ...
          <div className='flex items-center space-x-4'>
            ...
            <div>
              ...
              <p className='font-medium'>{formatDate(currentEmployee.employee_doj)}</p>
            </div>
          </div>
