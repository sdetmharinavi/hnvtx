      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
          <p className="mb-4 text-gray-700 dark:text-gray-300">
            Your privacy is important to us. It is Harinavi Transmission Maintenance&apos;s policy
            to respect your privacy regarding any information we may collect from you across our
            website.
          </p>
          <p className="mb-4 text-gray-700 dark:text-gray-300">
