...
export const getDownloadUrl = (url: string | null | undefined) => {
  if (!url) return '';
...
const RecentlyUploaded: React.FC<RecentlyUploadedProps> = ({ uploadedFiles }) => {
  return (
    <div className='space-y-4'>
      <h3 className='text-lg font-semibold text-gray-900 dark:text-white'>Recently Uploaded</h3>
