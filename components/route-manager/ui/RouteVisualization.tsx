            ...
            <div className='absolute top-0 left-0 right-0 h-full'>
              {allPoints.map((point, index) => {
                ...
                return (
                  <motion.div
                    key={uniqueKey}
                    // THE FIX: Added `z-10 hover:z-50` to pop overlapping points to the front on hover
                    className='absolute top-1/2 flex flex-col items-center group z-10 hover:z-50'
                    style={{
                  ...
                  >
                    ...
                    <div
                      ...
                      className={`relative w-6 h-6 rounded-full border-4 flex items-center justify-center transition-all duration-300 shadow-lg ${
                        point.type === 'site'
                  ...
                  <div className='flex justify-between items-center'>
                    <div className='flex items-center space-x-3'>
                      ...
                      <div className='text-sm'>
                        ...
                        <span className='font-medium text-gray-800 dark:text-gray-200'>
                          <TruncateTooltip text={end?.name || 'Unknown'} />
                        </span>
                      </div>
                    </div>
                    <div className='flex items-center space-x-2'>
