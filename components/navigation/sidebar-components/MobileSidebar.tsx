// components/navigation/sidebar-components/MobileSidebar.tsx
'use client';
...
import { useScrollLock } from '@/hooks/useScrollLock'; // THE FIX: Imported scroll lock hook
...
export const MobileSidebar = ({
  ...
  // THE FIX: Lock the background scroll when the mobile menu is open
  useScrollLock(!isCollapsed);
    ...
    <>
      ...
      >
        ...
        <div className='flex-1 overflow-y-auto py-4 custom-scrollbar'>
          ...
          <QuickActions isCollapsed={false} pathname={pathname} />
        </div>
