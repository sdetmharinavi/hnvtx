  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title={isEdit ? "Edit OFC Connection" : "Add OFC Connection"} size='full' visible={false} className='h-screen w-screen transparent bg-gray-700 rounded-2xl'>
      <FormCard title={isEdit ? "Edit OFC Connection" : "Add OFC Connection"} onSubmit={handleSubmit(onValidSubmit)} onCancel={handleClose} standalone>
        ...
        <FormInput name='otdr_distance_sn_km' label='OTDR Distance SN (km)' register={register} step='0.001' error={errors.otdr_distance_sn_km} disabled={submitting} />

        <FormInput name='sn_power_dbm' label='SN Power (dBm)' register={register} step='0.01' error={errors.sn_power_dbm} disabled={submitting} />

        <FormInput name='otdr_distance_en_km' label='OTDR Distance EN (km)' register={register} step='0.001' error={errors.otdr_distance_en_km} disabled={submitting} />

        <FormInput name='en_power_dbm' label='EN Power (dBm)' register={register} step='0.01' error={errors.en_power_dbm} disabled={submitting} />

        {/* Overall Measurements */}
        <FormInput name='route_loss_db' label='Route Loss (dB)' register={register} step='0.01' error={errors.route_loss_db} disabled={submitting} />
