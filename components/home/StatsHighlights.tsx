        ...
        >
          ...
          <div className="relative z-10 text-center">
            ...
            <motion.div
              ...
              className="text-2xl sm:text-3xl md:text-4xl font-black bg-red-400 bg-gradient-to-r from-red-400 to-orange-500 dark:from-blue-400 dark:to-cyan-400 bg-clip-text text-transparent mb-1 sm:mb-2"
            >
              {stat.number}
            </motion.div>
