...
export const ExpenseFormModal: React.FC<ExpenseFormModalProps> = ({
  ...
  // ADDED: Options for Terminal / Location dropdown
  const terminalOptions = [
    { value: 'HNV TM', label: 'HNV TM' },
    { value: 'JDP TM', label: 'JDP TM' },
    { value: 'RUSSA TM', label: 'RUSSA TM' },
    { value: 'KGT TM', label: 'KGT TM' },
  ];
  ...
  const form = useForm<ExpensesInsertSchema & { spent_by_employee_id?: string | null }>({
    ...
    defaultValues: {
      ...
      invoice_no: '',
      amount: 0,
      terminal_location: 'HNV TM', // Default value
      description: '',
    ...
    if (isOpen) {
      if (record) {
        reset({
          ...
          category: record.category || 'Point To Point',
    ...
    <BaseFormModal
      ...
      <div className='space-y-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          ...
          {/* CHANGED: Replaced free-text FormInput with FormSearchableSelect */}
          <FormSearchableSelect
