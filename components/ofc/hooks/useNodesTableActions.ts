  ...
  return useMemo(
    () => [
      ...
      },
      {
        key: "activate",
        label: "Activate",
        hidden: (r: Row<"nodes">) => Boolean((r).status) === true,
        onClick: (r: Row<"nodes">) => onToggleStatus((r).id, true),
        icon: createElement(FiToggleRight),
      },
      {
        key: "deactivate",
        label: "Deactivate",
        hidden: (r: Row<"nodes">) => Boolean((r).status) === false,
        onClick: (r: Row<"nodes">) => onToggleStatus((r).id, false),
      ...
      },
      {
        ...
        onClick: (r: Row<"nodes">) => onDelete((r).id, String((r).name ?? "this node")),
