          ...
          {cable.asset_no && (
            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
              ...
              <span className="truncate">
                Asset: <span className="font-mono">{cable.asset_no}</span>
              </span>
            </div>
          )}
          {cable.transnet_id && (
            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
              ...
              <span className="truncate">
                Transnet ID: <span className="font-mono">{cable.transnet_id}</span>
              </span>
            </div>
          )}
          {cable.remark && (
            <div className="flex items-center gap-1.5 text-gray-600 dark:text-gray-400">
              ...
              <span className="truncate">
                Remarks: <span className="font-mono">{cable.remark}</span>
              </span>
            </div>
          )}
