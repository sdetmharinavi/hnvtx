  ...
  useEffect(() => {
    if (user) {
      ...
      reset({
        ...
        address: (user.address as object) || {},
    ...
    return (
      <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
        <div className='bg-white p-8 rounded-lg shadow-xl max-w-md w-full mx-4 text-center'>
          ...
          <button onClick={onClose} className='bg-gray-600 text-white px-4 py-2 rounded-lg hover:bg-gray-700 transition-colors'>
            Close
          </button>
        </div>
      </div>
    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4'>
      <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className='bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
        ...
        <div className='px-6 py-4 border-b border-gray-200 flex items-center justify-between sticky top-0 bg-white z-10'>
          ...
          <button onClick={handleClose} className='text-gray-400 hover:text-gray-600 p-1 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500'>
            <FiX size={20} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit(onValidSubmit)} className='p-6'>
          <div className='space-y-6'>
            ...
            <div className='flex items-center gap-4'>
              <div className='relative'>
                ...
                <button type='button' className='absolute -bottom-1 -right-1 bg-blue-600 text-white p-1.5 rounded-full hover:bg-blue-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'>
                  <FiCamera size={12} />
                </button>
              </div>
              <div className='flex-1'>
                ...
                <input id='avatar_url' type='url' {...register("avatar_url")} className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent' placeholder='https://example.com/avatar.jpg' />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <input id='first_name' type='text' {...register("first_name")} className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent' />
              ...
              <div>
                ...
                <input id='last_name' type='text' {...register("last_name")} className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent' />
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
              <div>
                ...
                <input id='phone_number' type='tel' {...register("phone_number")} className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent' placeholder='+1 (555) 123-4567' />
            ...
            <div>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                ...
                />
                <input type='text' {...register("address.city" as const)} className='w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500' placeholder='City' />
                <input
                  type='text'
              ...
              <div className='border-t border-gray-200 pt-6'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  <div>
                    ...
                    <select id='role' {...register("role")} className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'>
                  ...
                  <div>
                    ...
                    <select id='status' {...register("status")} className='w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent'>
          ...
          {/* Footer */}
          <div className='flex items-center justify-between mt-8 pt-6 border-t border-gray-200 sticky bottom-0 bg-white z-10'>
            <div className='text-sm text-gray-500'>{isDirty && "• Unsaved changes"}</div>

            <div className='flex items-center gap-3'>
              <button type='button' onClick={handleClose} className='px-4 py-2 text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'>
                Cancel
              </button>
              <button
                type='submit'
                disabled={!isDirty || isSubmitting}
                className='flex items-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'>
                <FiSave />
