...
export const SystemConnectionDetailsModal: React.FC<
  SystemConnectionDetailsModalProps
> = ({ isOpen, onClose, connectionId, parentSystem }) => {
        ...
        render: (val, record) => {
          return (
            <span className="font-semibold text-blue-950 dark:text-blue-50">
              {(val as string) ||
                (record as V_system_connections_completeRowSchema)
  ...
  const endPointData = useMemo(() => {
    ...
    const endA: Endpoint = {
      ...
      system_name:
        connection.sn_name || connection.system_name || "Unknown System",
    ...
    const endB: Endpoint = {
      ...
      protection_interface: (connection as any).en_protection_interface,
    };
  ...
  const renderCircuitMobile = useCallback((record: any) => {
    return (
  ...
  const renderFiberMobile = useCallback(
    (record: Row<"v_ofc_connections_complete">) => {
          ...
          <div className="flex justify-between text-xs pt-2 mt-1 border-t border-gray-100 dark:border-gray-700/50">
            <div className="flex flex-col">
              ...
              <span className="font-mono">
                {record.otdr_distance_sn_km
                  ? `${record.otdr_distance_sn_km} km`
                  : "-"}
              </span>
            ...
            <div className="flex flex-col items-end">
              ...
              <span className="font-mono">
                {record.otdr_distance_en_km
                  ? `${record.otdr_distance_en_km} km`
                  : "-"}
              </span>
