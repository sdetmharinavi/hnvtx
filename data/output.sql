--===== telecom_network_db/11_user_management/3_functions/3_trigger_functions/2_sync_user_role_to_auth.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/3_trigger_functions/3_create_public_profile_for_new_user.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/3_trigger_functions/1_update_user_profile_timestamp.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/1_admin_functions/3_admin_update_user_profile.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/1_admin_functions/1_admin_get_all_users.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/1_admin_functions/5_admin_bulk_update_role.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/1_admin_functions/6_admin_bulk_delete_users.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/1_admin_functions/2_admin_get_user_by_id.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/1_admin_functions/4_admin_bulk_update_status.sql =====
...
END;
$$;
--===== telecom_network_db/11_user_management/3_functions/2_utility_functions/3_get_my_user_details.sql =====
...
WHERE u.id = auth.uid();
$$;
--===== telecom_network_db/11_user_management/3_functions/2_utility_functions/2_get_my_role.sql =====
...
WHERE id = auth.uid();
$$;
--===== telecom_network_db/11_user_management/3_functions/2_utility_functions/1_is_super_admin.sql =====
...
CREATE POLICY "allow_own_profile_access_or_superadmin_access" 
ON public.user_profiles 
FOR ALL 
TO authenticated 
USING (auth.uid() = id OR public.is_super_admin())
WITH CHECK (auth.uid() = id OR public.is_super_admin());
--===== telecom_network_db/11_user_management/2_views/1_v_user_profiles_extended.sql =====
...
--===== telecom_network_db/11_user_management/2_views/2_admin_get_all_users_extended.sql =====
...
--===== telecom_network_db/11_user_management/4_triggers/3_sync_user_role_trigger.sql =====
...
BEGIN 
    ...
    END IF;
END $$;
--===== telecom_network_db/11_user_management/4_triggers/4_sync_user_role_insert_trigger.sql =====
...
BEGIN 
    ...
    END IF;
END $$;
--===== telecom_network_db/11_user_management/4_triggers/2_update_user_profile_updated_at.sql =====
...
BEGIN 
    ...
    END IF;
END $$;
--===== telecom_network_db/11_user_management/4_triggers/1_on_auth_user_created.sql =====
...
END;
$$;
--===== telecom_network_db/7_triggers/3_dom_update_triggers.sql =====
...
--===== telecom_network_db/7_triggers/2_updated_at_triggers.sql =====
...
create trigger trigger_sdh_node_associations_updated_at before update on sdh_node_associations for each row execute function update_updated_at_column();
--===== telecom_network_db/7_triggers/1_ring_node_count_trigger.sql =====
...
--===== telecom_network_db/9_utility_functions/1_query_execution/1_execute_sql.sql =====
...
--===== telecom_network_db/9_utility_functions/1_query_execution/2_get_unique_values.sql =====
...
--===== telecom_network_db/9_utility_functions/4_pagination/2_paged_ofc_cables_complete.sql =====
...
CREATE OR REPLACE FUNCTION public.get_paged_ofc_cables_complete(
    p_limit integer,
    p_offset integer,
    p_order_by text DEFAULT 'asset_no',
...
BEGIN 
  ...
  sql_query := format(
    ...
    SELECT 
      ...
      v.asset_no::text,
      v.route_name::text,
      v.starting_node_id::text,
      v.ending_node_id::text,
      v.capacity,
...
--===== telecom_network_db/9_utility_functions/4_pagination/1_paged_v_systems_complete.sql =====
...
SET search_path = public, auth, pg_temp;
--===== telecom_network_db/9_utility_functions/4_pagination/3_paged_nodes_complete.sql =====
...
--===== telecom_network_db/3_system_specific_tables/8_vmux_connections.sql =====
...
--===== telecom_network_db/3_system_specific_tables/6_maan_connections.sql =====
...
--===== telecom_network_db/3_system_specific_tables/7_sdh_connections.sql =====
...
--===== telecom_network_db/3_system_specific_tables/2_maan_systems.sql =====
...
--===== telecom_network_db/3_system_specific_tables/4_vmux_systems.sql =====
-- Dedicated Table for VMUX System Specific Details
create table vmux_systems (
  system_id UUID primary key references systems (id) on delete CASCADE,
  vm_id TEXT
);
--===== telecom_network_db/3_system_specific_tables/5_cpan_connections.sql =====
...
--===== telecom_network_db/3_system_specific_tables/1_cpan_systems.sql =====
...
--===== telecom_network_db/3_system_specific_tables/3_sdh_systems.sql =====
...
--===== telecom_network_db/10_rls_policies/5_sdh_node_associations_policies.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/4_management_ports_policies.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/10_vmux_connections.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/4_maan_systems.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/8_maan_connections.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/9_sdh_connections.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/7_cpan_connections.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/6_vmux_systems.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/2_generic_connections.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/5_sdh_systems.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/1_generic_systems.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/3_system_tables_policies/3_cpan_systems.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/1_enable_rls.sql =====
...
--===== telecom_network_db/10_rls_policies/2_core_tables_policies.sql =====
...
END;
$$;
--===== telecom_network_db/10_rls_policies/6_role_grants.sql =====
...
--===== telecom_network_db/4_indexes/1_core_indexes.sql =====
-- Core indexes
...
--===== telecom_network_db/4_indexes/2_composite_indexes.sql =====
...
--===== telecom_network_db/4_indexes/4_system_specific_indexes.sql =====
...
--===== telecom_network_db/4_indexes/3_lookup_type_indexes.sql =====
...
--===== telecom_network_db/1_master_tables/3_employee_designations.sql =====
...
--===== telecom_network_db/1_master_tables/2_maintenance_areas.sql =====
...
--===== telecom_network_db/1_master_tables/4_employees.sql =====
...
--===== telecom_network_db/1_master_tables/1_lookup_types.sql =====
...
--===== telecom_network_db/2_core_infrastructure/7_management_ports.sql =====
...
--===== telecom_network_db/2_core_infrastructure/8_sdh_node_associations.sql =====
...
--===== telecom_network_db/2_core_infrastructure/4_systems.sql =====
...
--===== telecom_network_db/2_core_infrastructure/2_nodes.sql =====
...
--===== telecom_network_db/2_core_infrastructure/5_ofc_connections.sql =====
...
--===== telecom_network_db/2_core_infrastructure/1_rings.sql =====
-- Ring Master Table
create table rings (
  id UUID primary key default gen_random_uuid(),
  name TEXT not null,
...
--===== telecom_network_db/2_core_infrastructure/6_system_connections.sql =====
...
--===== telecom_network_db/2_core_infrastructure/3_ofc_cables.sql =====
