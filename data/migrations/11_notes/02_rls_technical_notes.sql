-- path: data/migrations/11_notes/02_rls_technical_notes.sql
-- Description: Applies a tiered Row-Level Security model to the technical_notes table.
...
GRANT ALL ON public.technical_notes TO authenticated;
-- Grant necessary permissions to admin roles. RLS will scope their access.
GRANT ALL ON public.technical_notes TO admin;
GRANT ALL ON public.technical_notes TO admin_pro;


-- =================================================================
-- Section 2: RLS Policies for technical_notes
-- =================================================================

-- Drop old policies for idempotency
DROP POLICY IF EXISTS "Users can manage their own diary notes" ON public.technical_notes;
DROP POLICY IF EXISTS "Admins can read all diary notes" ON public.technical_notes;
DROP POLICY IF EXISTS "Pro Admins can manage all diary notes" ON public.technical_notes;
DROP POLICY IF EXISTS "Admins and Pro Admins can manage all diary notes" ON public.technical_notes;
