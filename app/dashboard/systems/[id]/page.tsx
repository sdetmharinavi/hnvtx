...
import { PageSpinner, ErrorDisplay, Button, SearchableSelect, ConfirmModal } from '@/components/common/ui';
import { PageHeader } from '@/components/common/page-header';
import { GitBranch, ChevronsRight, Plus, RefreshCw, ZapOff } from 'lucide-react';
...
export default function RingProvisioningPage() {
