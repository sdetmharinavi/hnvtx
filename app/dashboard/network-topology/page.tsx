...
export default function NetworkTopologyPage() {
  ...
  const { nodes, cables, isLoading, isError, error, refetch } =
    useNetworkTopologyData(selectedAreaId);
  ...
  return (
    <div className="p-4 md:p-6 space-y-6">
      ...
      <div className="h-[70vh] bg-white dark:bg-gray-800 rounded-lg shadow-md border dark:border-gray-700 p-4">
        ...
        {!isLoading && !isError && <NetworkTopologyDiagram nodes={nodes} connections={cables} />}
      </div>
    </div>
  );
}
