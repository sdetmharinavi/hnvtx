...
export default function AuditLogsPage() {
  ...
  const orderedColumns = useOrderedColumns(columns, [
    ...TABLE_COLUMN_KEYS.v_audit_logs,
  ]);
  ...
  const headerActions = useStandardHeaderActions<"v_audit_logs">({
    ...
    exportConfig: { tableName: "v_audit_logs", useRpc: true },
  });
  ...
  const headerStats = useMemo<StatProps[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        color: "success",
        onClick: () =>
          filters.setFilters((prev) => ({ ...prev, action_type: "INSERT" })),
      ...
      },
      {
        ...
        color: "primary",
        onClick: () =>
          filters.setFilters((prev) => ({ ...prev, action_type: "UPDATE" })),
      ...
      },
      {
        ...
        color: "danger",
        onClick: () =>
          filters.setFilters((prev) => ({ ...prev, action_type: "DELETE" })),
  ...
  const renderMobileItem = useCallback(
    (record: Row<"v_audit_logs">, actions: React.ReactNode) => {
  ...
  return (
    <DashboardPageLayout
      crud={crud}
      header={{
        title: "System Audit Logs Reader",
        description:
          "Read-only view of historical user activities and data changes.",
        icon: <FiShield />,
        stats: headerStats,
