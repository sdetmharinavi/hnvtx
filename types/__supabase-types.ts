  ...
  public: {
    Tables: {
      ...
      nodes: {
        Row: {
          ...
          otdr_distance_km: number | null
          otdr_loss_db: number | null
    ...
    Functions: {
      ...
      admin_bulk_update_role: {
        Args: { user_ids: string[]; new_role: string }
        Returns: boolean
      }
      admin_bulk_update_status: {
        Args: { user_ids: string[]; new_status: string }
        Returns: boolean
      }
      admin_get_all_users: {
        Args: {
      ...
      bulk_update: {
        Args: { table_name: string; updates: Json; batch_size?: number }
        Returns: Json
      }
      execute_sql: {
