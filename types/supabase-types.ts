  ...
  public: {
    Tables: {
      ...
      port_power_readings: {
        ...
        Relationships: [
          {
            foreignKeyName: "port_power_readings_recorded_by_user_id_fkey"
          ...
          {
            foreignKeyName: "port_power_readings_ring_id_fkey"
            columns: ["ring_id"]
            isOneToOne: false
            referencedRelation: "rings"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "port_power_readings_system_id_fkey"
            columns: ["system_id"]
            isOneToOne: false
            referencedRelation: "systems"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_latest_connection_power_readings: {
        Args: { p_system_connection_id: string }
        Returns: Json
      }
      get_lookup_type_id: {
      ...
      log_multiple_port_power_readings: {
        Args: { p_readings: Json; p_ring_id: string }
        Returns: undefined
      }
      log_user_activity: {
        Args: {
      ...
      update_ring_path_configuration: {
        Args: {
          p_bandwidth?: string
          p_dest_port?: string
          p_dest_system_id?: string
          p_link_type_id?: string
          p_new_name: string
          p_path_id: string
          p_source_port: string
