...
export const useOfcData = useGenericDataQuery<'v_ofc_cables_complete'>({
  ...
  filterFn: (c, filters) => {
    ...
    if (filters.maintenance_terminal_id && c.maintenance_terminal_id !== filters.maintenance_terminal_id) return false;
    ...
    // Note: 'sortBy' is handled inside useGenericDataQuery automatically for 'last_activity'
    return true;
  }
});