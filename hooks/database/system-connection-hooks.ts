...
// CORRECTED: Define a more flexible type for the form data that allows p_id to be added.
export type SystemConnectionFormData = Partial<RpcFunctionArgs<'upsert_system_connection_with_details'>>;